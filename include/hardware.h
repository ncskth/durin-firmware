...
#define PIN_UART_USER_TX GPIO_NUM_1
#define PIN_UART_USER_RX GPIO_NUM_3
#define PIN_UART_USER_CTS GPIO_NUM_19
#define PIN_UART_USER_RTS GPIO_NUM_22
#define UART_USER_RTS_THRESHOLD 255
...
#define PIN_IRQ_UWB GPIO_NUM_36
